...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            fetch("http://localhost:50912/api/Categorias/ObtenerCategorias")
            ...
            dropdownCategorias.addEventListener("click", function () {
                const categoriaSeleccionada = dropdownCategorias.textContent;
                ...
                if (categoriaSeleccionada !== "Selecciona una categoría") {
                    ...
                    fetch(`http://localhost:50912/api/Platillos/ObtenerPlatillosPorCategoria?categoria=${categoriaSeleccionada}`)
                        .then(response => response.json())
                        .then(data => {
